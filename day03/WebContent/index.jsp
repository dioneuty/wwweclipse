...
<body>
	<table width="100%">
		...
		<tr>
			...
			<td width="10%" align="center" bgcolor="#ffaaaa"><a href="intro/page1.jsp">회사소개</a></td>
			<td bgcolor="#ffdddd">&nbsp;</td>
			<td width="10%" align="center" bgcolor="#ffaaaa"><a href="emp/list.jsp">사원관리</a></td>
			<td bgcolor="#ffdddd">&nbsp;</td>
			<td width="10%" align="center" bgcolor="#ffaaaa"><a href="login/login.jsp">login</a></td>
			<td bgcolor="#ffdddd">&nbsp;</td>
		</tr>
		<!-- menu end -->
		<!-- content -->
