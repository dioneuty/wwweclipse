...
<body>
	...
	<table>
		<!-- 로고 -->
		<tr>
			<td colspan="6"><img alt="logo" src="imgs/logo.jpg"></td>
		</tr>
		<!-- 메뉴 -->
		<tr>
			<td>&nbsp;&nbsp;&nbsp;</td>
...
%>
				<table width="500" cellspacing="0" border="1" align="center">
					...
					<tr>
						...
						<td><a href="viewone.jsp?num=<%=rs.getInt("num") %>"><%=rs.getInt("tot") %></a>
						</td>
					</tr>
					<%} %>
				</table> <% 
...
%>
		...
		<!-- 꼬리말 -->
		<tr>
			<td colspan="6">(주)한빛이엔아이 ｜ 사업자등록번호 : 220-85-43667 ｜ 통신판매신고 : 마포
				제 0358호 한빛ENI : 02-707-1480 / (121-854) 서울시 마포구 신수동 63-14 구프라자 3층 /
